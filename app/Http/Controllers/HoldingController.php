...
class HoldingController extends Controller
{
    ...
    public function update(Request $request, Holding $holding)
    {
        $request->validate([
            ...
            'data_abertura.required' => 'O campo Data de Abertura é obrigatório.',
            ...
            'capital_social.required' => 'O campo Capital Social é obrigatório.',
            'faturamento_anual.required' => 'O campo Faturamento Anual é obrigatório.',
            'responsavel_contabil.required' => 'O campo Responsável Contábil é obrigatório.',
            'codigo_tributacao.required' => 'O campo Código de Tributação é obrigatório.',
            'aliquota_fiscais.required' => 'O campo Alíquotas Fiscais é obrigatório.',
            'socio.required' => 'O campo Socio é obrigatório.',
            'cpf.required' => 'O campo CPF é obrigatório.',
            'cpf.cpf' => 'Informe um CPF válido para o campo CPF.',
            'participacao_societaria.required' => 'O campo Participação Societária é obrigatório.',
            'cargo.required' => 'O campo Cargo é obrigatório.',
            'natureza_juridica.required' => 'O campo Natureza Jurídica é obrigatório.',
            'regime_tributario.required' => 'O campo Regime Tributário é obrigatório.',
        ]);
