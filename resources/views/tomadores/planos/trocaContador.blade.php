                        ...
                        <form action="{{ route('tomadores.planos.storeTroca') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="nome_fantasia" value="{{ old('nome_fantasia') }}" name="nome_fantasia">
                                </div>
                                <div class="col-md-4 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4 pt-5 text-center">
                                    <button type="submit" class="themeBtn">Enviar Solicitação</button>
                                </div>
                            </div>
                        </form>
                    </div>
