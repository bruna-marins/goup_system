        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="#"><img src="{{ asset('imagens/logo.svg') }}" alt="Logo da Empresa"></a>
                    <a class="navbar-brand brand-logo-mini" href="#"><img src="{{ asset('imagens/logo-mini.svg') }}" alt="Logo da Empresa"></a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                ...
                                <a href="https://dinerb.com.br/" class="text-muted" target="_blank">DINERB</a>. Todos os direitos reservados.</span>
                                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted"> Política de Privacidade  | Termo de Uso</span>
                            </div>
                        </div>    
                    </div>        
                </footer>
