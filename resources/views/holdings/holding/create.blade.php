                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cep" id="cep"
                                                value="{{ old('cep') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="socio" id="socio"
                                                value="{{ old('socio') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cpf" id="cpf"
                                                value="{{ old('cpf') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="participacao_societaria"
                                                id="participacao_societaria" value="{{ old('participacao_societaria') }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="cargo" id="cargo"
                                                value="{{ old('cargo') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
